...
<div class="box">
  <header class="header">
    <van-nav-bar title="购物车1" left-arrow @click-left="$router.back()"></van-nav-bar>
  </header>
  <div class="content">
...
export default {
  ...
  methods: {
    ...
    ...mapActions({
      ...
      // 组件中访问 this，change_cart_list()相当于执行了this.$store.commit('cart/change_cart_list')
    })
  },
  mounted () {
    if (!this.loginState) {
