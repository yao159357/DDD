define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/address/addressdefaultupdate",
    "title": "4 修改默认地址接口",
    "name": "postAddressdefaultupdate",
    "group": "address",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>描述  根据请求接口的状态会返回对应的数据 res.send({ code:'200', message:'请求地址列表', data })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '请求地址列表', data })</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/address/defualtAddress",
    "title": "获取默认地址",
    "name": "postDefualtAddress",
    "group": "address",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '更新所有的钻中和非选中状态' })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '删除购物车的数据'， data })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '更新订单的地址'， data })</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/api/pro/categroy",
    "title": "获取商品的分类数据",
    "name": "GetApiProCategroy",
    "group": "pro",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "get",
    "url": "/api/pro/categroybrand",
    "title": "获取分类下的品牌的数据",
    "name": "GetApiProCategroybrand",
    "group": "pro",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "get",
    "url": "/api/pro/categroybrandlist",
    "title": "获取分类下的品牌的列表数据",
    "name": "GetApiProCategroybrandList",
    "group": "pro",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '获取分类下的品牌的列表数据', data })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '验证码验证成功', data }) res.send({ code:&quot;10004&quot;, message:&quot;验证码验证失败&quot;, })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '200', message: '可以继续注册', data }) res.send({ code:&quot;10002&quot;, message:&quot;该用户已经注册&quot;, tel:data[0].tel })</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Success-Response:",
            "description": "<p>res.send({ code: '10006', message: '验证码错误', }) res.send({ code:&quot;10005&quot;, message:&quot;该用户还未注册&quot;, }) res.send({ code:&quot;200&quot;, message:&quot;登陆成功&quot;, data:{ userid:data1[0].userid, //token:-------后端校验登陆的凭证 } })</p>"
          }
        ]
      }
    },
